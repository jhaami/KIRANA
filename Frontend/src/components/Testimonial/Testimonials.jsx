...
const Testimonials = () => {
  ...
  return (
    <Slider {...settings}>
      <div className="testimonial py-4 px-3">
        <div>
          <h6 className="mb-0 mt-3">"Shavvy has completely transformed the way we run our store!"</h6>
        </div>
      ...
      <div className="testimonial py-4 px-3">
        <div>
          <h6 className="mb-0 mt-3">"Shavvy has made managing my store so much easier!"</h6>
        </div>
        <p className="fst-italic">
  ...
  <p className="fst-italic">
    "Shavvy has become my go-to platform for restocking my store. Their support team is always available, and their commitment to quality is unmatched."
  </p>
  <div className="d-flex align-items-center gap-4 mt-3">
    <img src={ava02} className="w-25 h-25 rounded-2" alt="" />
    <div>
...
<div className="testimonial py-4 px-3">
  <div>
    <h6 className="mb-0 mt-3">"Shavvy simplifies everything for us!"</h6>
  </div>
  <p className="fst-italic">
...
<div className="testimonial py-4 px-3">
  ...
  <p className="fst-italic">
    "Shavvy provides everything I need in one place. Their eco-friendly options and competitive prices help me cater to my customers more effectively."
  </p>
  <div className="d-flex align-items-center gap-4 mt-3">
    <img src={ava02} className="w-25 h-25 rounded-2" alt="" />
    <div>
...
<div className="testimonial py-4 px-3">
  ...
  <p className="fst-italic">
    "With Shhavvy, I have access to high-quality products that my customers love. Their fast delivery ensures my shelves are always stocked."
  </p>
  <div className="d-flex align-items-center gap-4 mt-3">
    <img src={ava03} className="w-25 h-25 rounded-2" alt="" />
    <div>
